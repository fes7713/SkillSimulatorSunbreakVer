...
public class Leg extends Armor {
    ...
    public Leg(String title, Map<Skill, Integer> skills, int slot4, int slot3, int slot2, int slot1) {
        super(title, skills, slot4, slot3, slot2, slot1);
    }

    public Leg(String title, int slot4, int slot3, int slot2, int slot1) {
